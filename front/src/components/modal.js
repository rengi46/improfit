...
export const Modal = ({close,children}) => {
  return (
    <div  className="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal h-full justify-center items-center">
      <div className="relative p-4 w-full max-w-md h-full m-auto md:h-auto ">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 m-auto">
          ...
          <div className="py-6 px-6 lg:px-8">
            <h3 className="mb-4 text-center text-xl font-medium text-gray-900 dark:text-white">upload the image to de cloud</h3>
          </div>
          {children}
        </div>
      </div>
